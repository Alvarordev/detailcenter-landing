...
const HeroLanding = () => {
    return ( 
        ...
        <div className="w-full lg:max-w-[1280px] mx-auto relative z-20 px-8 mb-24 move-in-left">
          <div>
            <Link href={"/contacto"} className="lg:ml-16 bg-red-500 text-white w-full lg:w-[200px] flex items-center justify-center py-5 transition-all font-medium cursor-pointer hover:saturate-100 hover:translate-x-1 hover:-translate-y-1">
              Contáctanos
            </Link>
          </div>
        </div>
        ...
        <p className="text-[113px] xl:text-[280px] text-gray-50 absolute xl:top-20 -left-12 font-medium opacity-80 slow-motion fading-slow-mo hidden md:block">
          DetailCenter
        </p>
      </section>
     );
